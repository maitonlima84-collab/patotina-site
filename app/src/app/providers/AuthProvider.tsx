...
// Papéis do painel, na mesma disciplina do OnTrac (lista de strings no
// documento do usuário, conferida pelas regras do Firestore). Os papéis do
// app de gestão (Secretaria, Financeiro, Professor, Responsavel) entram aqui
// quando o módulo nascer — o site só precisa destes dois.
export const PAPEIS = ['Master', 'Editor'] as const
